			...
			<div class="row clearfix bordertop borderbottom" style="padding-top:2%; padding-bottom:2%">
				...
				<div class="col-md-8 col-sm-8  col-lg-8  column " style="padding-top:5%;">
					<ul class="list-unstyled">
						...
						<li style="margin:10px;"><a href="chooseseat1.php?ticket=<?php echo $result['ticketname'];?>&place=<?php echo $result['ticketplace'];?>" target="_blank"><button name="submitnum" class="btn btn-warning" style="width:160px; height:40px; margin-top:20px;">选购座位</button></a></li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="row clearfix bordertop borderbottom" style="padding-top:2%; padding-bottom:2%">
				<div class="col-xs-12">
					<ul class="list-unstyled">
						...
						<li ><a href="chooseseat1.php?ticket=<?php echo $result['ticketname'];?>&place=<?php echo $result['ticketplace'];?>" target="_blank"><button name="submitnum" class="btn btn-warning" style="width:160px; height:40px; margin-top:20px;">选购座位</button></a></li>
					</ul>
				</div>
			</div>
		</div>
								...
								<div id="myTabContent" class="tab-content" style="margin-top:15px;">
									...
									<div class="tab-pane fade" id="ios" style="border:2px double #eee; padding:10px 50px;" id="home">
										<h3>Leave Your Word Here</h3>
      									<p>
              								<form action="checkcomment1.php" method="post" name="comment">
								...
								<div class="col-md-12 column">
									<div class="row clearfix">
										<div class="col-md-6 column">
											<a href="indexsearch1.php?ticket=<?php echo $resultrecomment['ticketname'];?>&type=<?php echo $resultrecomment['tickettype'];?>"><img alt="140x140" src="<?php echo $resultrecomment['ticketspic']?>"  width="100px;" height="130px;" style="border-radius:4px;"/></a>
										</div>
