				...
				?>
					...
					<div class="col-md-6 text-center" style="border:1px solid #eee;box-shadow:0px 0px 5px #eee; padding-top:10px;padding-bottom:10px;">
						...
						<div class="row clearfix">
							...
							?>
										<a href="checkbuy.php?postticket=<?php echo $ticket;?>&orderprice=<?php echo $resultprice['seatprice'];?>&ticketnum=1&seat=<?php echo $seatn?>&area=<?php echo $area?>"><div class="btn btn-xs btn-warning ma seat"><?php echo $seatn;?></div></a>
							<?php
										}
