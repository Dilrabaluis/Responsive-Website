	...
	<div class="layer">
		...
		<div class="bottom-grid">
			...
			<div class="links">
				<ul class="links-unordered-list">
					<li >
						<a href="login1.php" class="">Login</a>
					</li>
		...
		<div class="content-w3ls">
			<div class="text-center">
				<p style="font-size:30px; font-weight:bold; color:#fff; margin-bottom:3%;">用户注册</p>
			</div>
			<div class="content-bottom">
				<form method="post" action="registionch1.php" name="regis">
					<div class="field-group">
						<span class="glyphicon glyphicon-user" aria-hidden="true"></span>
						<div class="wthree-field">
							<input name="username" id="text1" type="text" placeholder="Username" onBlur="checkName(regis)" required>
						</div>
					</div>
                    ...
                    <div class="field-group">
						...
						<div class="wthree-field">
							<input name="tel" id="myInput" type="text"  placeholder="Telphone" onBlur="checkTel(regis)" required>
						</div>
					</div>
		...
		<!-- <div class="bottom-grid1">
			<div class="links">
				<ul class="links-unordered-list">
					<li class="">
						<a href="#" class="">Call Us:15923257515</a>
					</li>
					<li class="">
