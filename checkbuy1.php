		...
		<div class=" hidden-xs col-sm-12 col-lg-12 col-md-12 column">
			<div class="row clearfix">
				<div class="col-md-8 col-md-offset-2 col-lg-8  col-lg-offset-2 col-sm-12 column">
					<form name="infomation" action="producebuy1.php?ticket=<?php echo $ticket?>&tickettime=<?php echo $result['tickettime'];?>&ticketnum=<?php echo $_GET['ticketnum'];?>&orderprice=<?php echo $_GET['orderprice'];?>&seat=<?php echo $seat;?>&area=<?php echo $area;?>" method="post">
					<div class="row clearfix">
							...
							<div class="row clearfix">
								...
								<div class="col-md-6 col-sm-6 col-lg-6 controls controls-row" style="margin-top:2%;">
									<div class="input-group input-group-lg " >
										...
										<input type="text" name="getphone" class="form-control" value="<?php echo $resulttel['usertel'];?>" placeholder="收货号码">
									</div>
								</div>
								<?php
								}else{
							...
							<div class="row clearfix">
								...
								<div class="col-md-6 col-sm-6 col-lg-6 controls controls-row" style="margin-top:2%;">
									<div class="input-group input-group-lg " >
										...
										<input type="text" name="getpost" class="form-control" placeholder="收货邮编">
									</div>
								</div>
							</div>
						</div>
