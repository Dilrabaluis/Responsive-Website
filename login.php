    ...
    <div class="container">
		<div id="wrapper" class="login-page center-block">
			<div id="login_form" class="form" method="post">
				<form class="register-form" name="regis" method="post" action="registionch.php" >
					<p><h4 style="font-weight:bold; color:#fff">用户注册</h4></p>
					...
					<div class="row clearfix">
						<div class="col-md-12">
							<input type="text" name="tel" placeholder="电话号码" onBlur="checkTel(regis)" required/>
						</div>
					</div>
					<div class="row clearfix">
						<div class="col-md-12 text-left" id="phone" style="font-size:12px; color:red; padding-left:5%;"></div>
					</div>
					<div class="row clearfix">
						<div class="col-md-12">
				...
				<form class="login-form" method="post" action="checkuser.php">
					<p><h4 style="font-weight:bold; color:#fff">用户登录</h4></p>
						<input type="text" name="username" placeholder="用户名" id="user_name" value="user" required/>
						<input type="password" name="pwd"   placeholder="密码" id="password" value="1111111" required/>
						<input name="submitlog" class="submitlog" type=submit id="login" value="立即登录">
						<a href="adminlog.php"><input type="button" class="submitlog" value="管理员登录"  style="color:#000;"/></a>
