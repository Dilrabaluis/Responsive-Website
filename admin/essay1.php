    ...
    <div class="container-fluid"> 
			...
			<div class="collapse navbar-collapse text-center" id="example-navbar-collapse">
					<ul class="nav navbar-nav" style="display: inline-block;float: none;">
						...
						<li  class="active"><a href="essay1.php">文章管理</a></li>
        ...
        <div class="tab-pane fade in active addwarningbg" id="add">
            <div class="row clearfix">
                <div class="col-md-12 column">
                    <form class="bs-example bs-example-form" role="form" method="post" enctype="multipart/form-data" method="post" action="addessay1.php">
                        <div class="row clearfix">
            ...
            <table class="table table-bordered table-striped">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="deleteessay1.php?title=<?php echo $result['essaytitle'];?>"><i class="glyphicon glyphicon-trash"></i></a>  
                        </td>
