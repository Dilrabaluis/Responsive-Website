...
<div class="navbar hidden-xs" role="navigation"> 
    <div class="container"> 
		...
		?>
			...
			<li style="display:inline-block;"><a href="checkadmin1.php" style="color:#000;"><span class="glyphicon glyphicon-th"></span>&nbsp;购票系统</a></li> 
		<?php
			}else{
		?>
        ...
        <div class="tab-pane fade in active addwarningbg" id="add">
            <div class="row clearfix">
                <div class="col-md-12 column">
                    <form class="bs-example bs-example-form" role="form" name="addgym" method="post" enctype="multipart/form-data" action="upimage1.php">
                        <div class="row clearfix">
            ...
            <table class="table table-bordered table-striped">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="deletegym1.php?place=<?php echo $result['placename'];?>"><i class="glyphicon glyphicon-trash"></i></a>  
                        </td>
                    </tr>
