        ...
        <div class="tab-pane fade in active addwarningbg" id="add">
            <div class="row clearfix">
                <div class="col-md-12 column">
                    <form class="bs-example bs-example-form" role="form" method="post" enctype="multipart/form-data" method="post" action="addticket.php">
                        <div class="row clearfix">
                                    ...
                                    <div class="col-md-10" style="margin-top:10px;">
                                        <div class="input-group input-group-lg">
                                            <span class="input-group-addon addinfo"></span>
                                                <input name="tickettime" type="text" class="form-control" placeholder="添加演出时间" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <table class="table table-bordered table-striped">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="deleteticket.php?ticket=<?php echo $result['ticketname'];?>"><i class="glyphicon glyphicon-trash"></i></a>  
                        </td>
                        <td>
                            <a href="updateticket.php?ticket=<?php echo $result['ticketname'];?>"><i class="glyphicon glyphicon-pencil"></i></a>  
                        </td>
                    </tr>
