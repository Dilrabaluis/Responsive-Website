...
<div class="container bottomtopna" style="background:#eee; padding:10px; border-radius:5px;">
    <div class="row clearfix">
        <div class="col-md-8 col-md-offset-2">
            ...
            ?>
            <form class="bs-example bs-example-form" method="post" role="form" name="updateform" action="updateuseraction1.php?user=<?php echo $_GET['user'];?>">
                <div class="row clearfix">
...
<div class="container bottomtopna" style="background:#eee; padding:10px; border-radius:5px;">
    <div class="row clearfix">
        <div class="col-md-8 col-md-offset-2">
            <form class="bs-example bs-example-form" method="post" role="form" name="addform" action="adduser1.php">
                <div class="row clearfix">
                    <div class="col-md-6 ma">
                        <div class="input-group ">
                            <span class="input-group-addon">用户名</span>
