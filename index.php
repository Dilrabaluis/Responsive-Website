...
<div class="container">
		...
		<div class="col-md-2 column" >
			<div class="row clearfix">
				<div class="col-md-6 column">
					<a href="indexsearch.php?ticket=<?php echo $resulttime['ticketname']?>&type=<?php echo $resulttime['tickettype'];?>" target="_blank"><img class="img" alt="140x140" src="<?php echo $resulttime['ticketspic'];?>" width="150px;" height="230px;" /></a>
				</div>
			</div>
			<div class="row clearfix">
				<div class="col-md-12 column">
		...
		<div class="col-sm-4 column">
			<div class="row clearfix text-center" style="margin-top:5px;">
				<div class="col-sm-11 column text-center">
					<a href="indexsearch.php?ticket=<?php echo $resulttime['ticketname']?>&type=<?php echo $resulttime['tickettype'];?>" target="_blank"><img alt="140x140" class="img" src="<?php echo $resulttime['ticketspic'];?>" width="150px;" height="230px;" /></a>
				</div>
			</div>
	...
	<div class="row clearfix">
		...
		<div class="col-md-6 col-sm-6 col-xs-6 column text-right"><h3 style="font-size:16px;"><a href="more.php?type=navication&keyword=1" style="color:#000; text-decoration:none;">查看全部</a></h3></div>
	</div>
	<div class="row clearfix visible-lg visible-md" style="border-bottom:1px solid #ccc;">
		<?php
		...
		<div class="col-md-2 column">
			<div class="row clearfix">
				<div class="col-md-12 column">
					<a href="indexsearch.php?ticket=<?php echo $result['ticketname'];?>&type=<?php echo $result['tickettype'];?>"><img class="img" alt="140x140" src="<?php echo $result['ticketspic']?>" width="150px;" height="230px;"/></a>
				</div>
			</div>
			<div class="row clearfix">
				<div class="col-md-12 column">
	...
	<div class="row clearfix">
		...
		<div class="col-md-6 col-sm-6 col-xs-6 column text-right"><h3 style="font-size:16px;"><a href="more.php?type=navication&keyword=2" style="color:#000; text-decoration:none;">查看全部</a></h3></div>			
	</div>
	<div class="row clearfix visible-lg visible-md" style="border-bottom:1px solid #ccc; padding-bottom:10px;">
		...
		<div class="col-md-4 column">
			<div class="row clearfix">
				<div class="col-md-6 column">
					<a href="indexsearch.php?ticket=<?php echo $resulthuaju['ticketname'];?>&type=<?php echo $resulthuaju['tickettype'];?>"><img class="img"  alt="140x140" src="<?php echo $resulthuaju['ticketspic']?>" width="150px;" height="230px;"/></a>
				</div>
				<div class="col-md-6 column">
	...
	<div class="row clearfix">
		...
		<div class="col-md-6  col-lg-6 col-sm-6 col-xs-6  column text-right"><h3 style="font-size:16px;"><a href="moreessay.php" style="color:#000; text-decoration:none;">查看全部</a></h3></div>
	</div>
				...
				<div class="col-lg-4 col-md-4">
					<div class="thumbnail">
						...
						<div class="caption">
							...
							<p>
								 <a class="btn btn-warning" href="essay.php?title=<?php echo $resultessay['essaytitle'];?>">enter</a>
							</p>
						</div>
					</div>
				</div>
