		...
		<div class="col-md-12 column">
            ...
            ?>
				<div class="col-md-6 column">
					<div class="row clearfix">
						<div class="col-md-12 column">
							<a href="essay.php?title=<?php echo $result['essaytitle'];?>"><img alt="140x140" src="<?php echo $result['essaypic'];?>" width="100%"/></a>
						</div>
					</div>
					<div class="row clearfix">
						<div class="col-md-12 column">
							<div class="row clearfix">
								<div class="col-md-12 column">
                                    <p><a href="essay.php?title=<?php echo $result['essaytitle'];?>" style="color:#000; text-decoration:none;"><h4><strong><?php echo $result['essaytitle'];?></strong></h4></a></p>
