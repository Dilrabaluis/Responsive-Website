...
$name=$_SESSION['uname'];
else echo "<script> alert('请先登录');window.location='login.php';</script>"
?>
		...
		<div class="col-md-12 column" id="change">
					...
					<div class="roe clearfix">
						<div class="col-md-8 col-md-offset-2">
							<?php
								...
								if($result){
							?>
							<form method="post"  class="bs-example bs-example-form" role="form" name="modify"  action="modifychk.php">
								<div class="row clearfix">
			...
			<div class="row clearfix ">
						<div class="col-md-10 col-md-offset-1 section tab">
											...
											<table class="table table-bordered table-striped">
												...
												?>
													<tr>
														...
														<td><a href="deleteaddress.php?id=<?php echo $resultaddress['addressid'];?>"><span class="glyphicon glyphicon-trash"></span></a></td>
							...
							<div class="row clearfix">
								<div class="col-md-10 col-md-offset-1">
									<h3>添加收货地址</h3>
									<form method="post" name="addaddress"  action="addresscheck.php">
										<div class="row clearfix">
											<div class="col-md-6" style="margin-top:5px;">
												<div class="input-group">
			...
			<div class="row clearfix ">
				<div class="col-md-12 section tab">
					<div class="row clearfix">
						<div class="col-md-8 col-md-offset-2">
							<form name="pwdform" action="pwdcheck.php" method="post">
							<div class="row clearfix">
								<div class="col-md-6">
									<div class="row clearfix">
										<div class="col-md-12">
